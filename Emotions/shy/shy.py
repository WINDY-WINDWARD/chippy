...
def shy_hold(display,for_how_long=1):
    """shy and hold for the given time"""
    ...
    holdShy(display,imageFiles[-1],for_how_long)

def holdShy(display,img_file,for_how_long=1):
